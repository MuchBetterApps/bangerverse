...
**Fork, customize, deploy.** mailG exports a static site that connects directly to Banger. Choose Netlify, Vercel, or Cloudflare below to create your own repository copy and deploy mailG. [Deployment guide](apps/mailg/README.md#deploy-your-copy). Live browser sign-in depends on Banger's browser OAuth rollout.
